...
| 4 | 007 | [HeliosGen AI 创作工作台](projects/007-heliosgen/README.md) | [SegFault42/HeliosGen](https://github.com/SegFault42/HeliosGen) | 用一张图理解 AI 内容创作、可视化工作流和本地素材管理，以及桌面应用、本地服务与云端模型的分工。 | 已整理 | [演示](https://yydshly.github.io/0909_codex_project/projects/007-heliosgen/) |
<!-- PROJECT_INDEX:END -->
...
用一张图理解 AI 内容创作、可视化工作流和本地素材管理，以及桌面应用、本地服务与云端模型的分工。
