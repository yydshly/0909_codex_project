...
- [运行节点](assets/runtime-original.png)：一台机器内的 Claude 与 Codex 均在线。
- [文件产物](assets/result-original.png)：原版任务评论里的读回内容及待评审状态变化。
- [小队交接](assets/squad-original.png)：组长、成员、组长三段真实评论。
