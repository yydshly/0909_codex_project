...
![Invidious 能力与架构理解图：内容来自 YouTube，主服务组织网页和 API，数据库保存用户状态，Companion 处理播放](assets/overview.png)

[查看矢量原图](assets/overview.svg) · [下载 PNG](assets/overview.png) · [网页源码](index.html)
